...
figure
plot(1:6,AoII_mean_by_frame(1,:), 'b--o'); hold on;  plot(1:6,AoII_mean_by_frameR(1,:), 'r--*');
plot(1:6,AoII_mean_by_frame(2,:), 'k--o'); hold on;  plot(1:6,AoII_mean_by_frameR(2,:), 'g--*');
grid minor
...
figure
plot(1:6,Reward_mean_by_frame(1,:), 'b--o'); hold on;  plot(1:6,Reward_mean_by_frameR(1,:), 'r--*');
plot(1:6,Reward_mean_by_frame(2,:), 'k--o'); hold on;  plot(1:6,Reward_mean_by_frameR(2,:), 'g--*');
grid minor
legend(["ILoRa U-Type 1","ALOHA U-Type 1","ILoRa U-Type 2","ALOHA U-Type 2"]);
xlabel("Frame Number");
ylabel("Mean Reward");
